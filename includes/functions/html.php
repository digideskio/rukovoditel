    ...
    { 
      if(is_array($v))
      {
        ...
        {        
          ...
          $html .= '<div>' . input_checkbox_tag($name . '[]',$kk,$attributes) . ' <label for="' . generate_id_from_name($name . '[' . $kk . ']') . '">' . $vv . '</label></div>';
        }
      ...
      {           
        ...
        $html .= '<div>' . input_checkbox_tag($name . '[]',$k,$attributes) . ' <label for="' . generate_id_from_name($name . '[' . $k . ']') . '">' . $v . '</label></div>';
      } 
    }
