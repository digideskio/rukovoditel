...
define('TEXT_SKIN_TOOLTIP','По умолчанию, если внешний вид не задан, то пользователи могут изменять внешний вид.<br>Выбранный внешний вид будет установлен для всех пользователей и возможность изменять внешний вид будет скрыта.');
