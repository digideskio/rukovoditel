...
<?php echo button_tag(TEXT_BUTTON_ADD_NEW_VALUE,url_for('entities/fields_choices_form','entities_id=' . $_GET['entities_id'] . '&fields_id=' . $_GET['fields_id']),true,array('class'=>'btn btn-primary')) ?>
