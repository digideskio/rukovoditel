...
<p><?php echo TEXT_IMPORT_DATA_INFO ?></p>
  ...
  <div class="form-group">
    ...
    <div class="col-md-9">	
        ...
        echo select_tag('entities_id',$choices,'',array('class'=>'form-control input-large required')) 
  ...
  <div class="form-group">
    ...
    <div class="col-md-9">	
  	  <?php echo input_file_tag('filename',array('class'=>'form-control input-large required')) ?>
