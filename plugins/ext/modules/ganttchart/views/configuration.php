...
?>
<tr>
  <td style="white-space: nowrap;"><?php echo button_icon_delete(url_for('ext/ganttchart/configuration_delete','id=' . $reports['id'])) . ' ' . button_icon_edit(url_for('ext/ganttchart/configuration_form','id=' . $reports['id'])). ' ' . button_icon(TEXT_EXT_CHART_CONFIGURE_LISTING,'fa fa-cogs',url_for('ext/ganttchart/listing','id=' . $reports['id']),false) ?></td>
