...
<div class="form-body">  
  <div class="form-group">
  	<label class="col-md-3 control-label" ><?php echo TEXT_EXT_ENTER_LICENSE_KEY . ' <b>' . $_SERVER['HTTP_HOST'] . '</b>' ?></label>
    <div class="col-md-9">	
...
<div class="alert alert-danger"><?php echo TEXT_EXT_PRODUCT_KEY_NOT_CORRECT . ' ' . $_SERVER['HTTP_HOST'] ?></div>
...
<?php else: ?>
<p class="alert alert-success"><i class="fa fa-check"></i> <?php echo TEXT_EXT_LICENSE_ACTIVE. ' <b>' . $_SERVER['HTTP_HOST'] . '</b>' ?></p>
<?php endif ?>
